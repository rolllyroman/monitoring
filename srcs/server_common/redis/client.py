...
class StrictRedis(object):
    ...
    def __init__(self, host='localhost', port=6379,
        ...
        self.connection_read_pool = connection_pool
    ...
    def execute_command(self, *args, **options):
        ...
        # print 'test execute_command 1',pool.connection_kwargs
        # print 'test execute_command 2',args, options
        command_name = args[0]
    ...
    def execute_read_command(self, *args, **options):
        "Execute a command and return a parsed response"
        pool = self.connection_read_pool
        # print 'test execute_read_command 1',pool.connection_kwargs
        # print 'test execute_read_command 2',args, options
        command_name = args[0]
        connection = pool.get_connection(command_name, **options)
        try:
            connection.send_command(*args)
    ...
    def exists(self, name):
        ...
        return self.execute_read_command('EXISTS', name)
    __contains__ = exists
    ...
    def get(self, name):
        ...
        """
        return self.execute_read_command('GET', name)
    ...
    def keys(self, pattern='*'):
        ...
        return self.execute_read_command('KEYS', pattern)
    ...
    def mget(self, keys, *args):
        ...
        return self.execute_read_command('MGET', *args)
    ...
    def pttl(self, name):
        ...
        return self.execute_read_command('PTTL', name)
    ...
    def ttl(self, name):
        ...
        return self.execute_read_command('TTL', name)
    ...
    def lindex(self, name, index):
        ...
        """
        return self.execute_read_command('LINDEX', name, index)
    ...
    def llen(self, name):
        ...
        return self.execute_read_command('LLEN', name)
    ...
    def lrange(self, name, start, end):
        ...
        """
        return self.execute_read_command('LRANGE', name, start, end)
    ...
    def scard(self, name):
        ...
        return self.execute_read_command('SCARD', name)

    def sdiff(self, keys, *args):
        "Return the difference of sets specified by ``keys``"
        args = list_or_args(keys, args)
        return self.execute_read_command('SDIFF', *args)
    ...
    def sismember(self, name, value):
        ...
        return self.execute_read_command('SISMEMBER', name, value)

    def smembers(self, name):
        "Return all members of the set ``name``"
        return self.execute_read_command('SMEMBERS', name)
    ...
    def zcard(self, name):
        ...
        return self.execute_read_command('ZCARD', name)
    ...
    def zcount(self, name, min, max):
        ...
        """
        return self.execute_read_command('ZCOUNT', name, min, max)
    ...
    def zrange(self, name, start, end, desc=False, withscores=False,
        ...
        return self.execute_read_command(*pieces, **options)
    ...
    def zrank(self, name, value):
        ...
        ``name``
        """
        return self.execute_read_command('ZRANK', name, value)
    ...
    def zrevrank(self, name, value):
        ...
        """
        return self.execute_read_command('ZREVRANK', name, value)

    def zscore(self, name, value):
        "Return the score of element ``value`` in sorted set ``name``"
        return self.execute_read_command('ZSCORE', name, value)
    ...
    def hexists(self, name, key):
        ...
        return self.execute_read_command('HEXISTS', name, key)

    def hget(self, name, key):
        "Return the value of ``key`` within the hash ``name``"
        return self.execute_read_command('HGET', name, key)

    def hgetall(self, name):
        "Return a Python dict of the hash's name/value pairs"
        return self.execute_read_command('HGETALL', name)
    ...
    def hkeys(self, name):
        ...
        return self.execute_read_command('HKEYS', name)

    def hlen(self, name):
        "Return the number of elements in hash ``name``"
        return self.execute_read_command('HLEN', name)
    ...
    def hmget(self, name, keys, *args):
        "Returns a list of values ordered identically to ``keys``"
        args = list_or_args(keys, args)
        return self.execute_read_command('HMGET', name, *args)
