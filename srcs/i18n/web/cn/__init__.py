...
MENU_ORDER_TXT = '监控系统'#'奖品系统'
MENU_ORDER_BUY_TXT = '订单列表'
MENU_ORDER_RWARD_LIST_TXT = '监视服务请求列表'
MENU_ORDER_RWARD_CC_TXT = '奖品套餐配置'
MENU_ORDER_RWARD_CREATE_TXT = '创建奖品套餐'
MENU_ORDER_WECHAT_TXT = '订单列表'
MENU_ORDER_BUY_RECORD_TXT = '订单列表'
